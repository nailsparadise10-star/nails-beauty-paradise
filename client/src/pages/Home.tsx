...
import { Facebook, Instagram, Twitter } from "lucide-react"; // 1. Import Icon
...
              Services
            </button>
            <a href="/Free-Manicure" className="text-foreground hover:text-primary transition-colors">
              Free Manicure
            </a>
            <button 
...
          <div className="mt-16 text-center">
  ...
  <div className="flex justify-center gap-4 flex-wrap">
    {[
      { 
        name: "Facebook", 
        url: "https://facebook.com/paradisenailandbeauty", 
        icon: <Facebook size={18} /> 
      },
      { 
        name: "Instagram", 
        url: "https://instagram.com/nailsandbeauty_brisbane", 
        icon: <Instagram size={18} /> 
      },
      { 
        name: "Twitter", 
        url: "https://twitter.com/NailsP64928", 
      ...
      <Button
        key={social.name}
        variant="outline"
        className="border-primary text-primary hover:bg-primary/10 flex items-center gap-2 px-6"
        asChild // 2. Cho phép Button hoạt động như thẻ <a>
      >
        <a href={social.url} target="_blank" rel="noopener noreferrer">
          {social.icon} {/* 3. Hiển thị Icon */}
...
                <li><a href="/services#Pedimain" className="hover:text-primary transition-colors">Pedimain</a></li>
                <li><a href="/services#Nails" className="hover:text-primary transition-colors">Nails Extensions</a></li>
                <li><a href="/services#Eyelash" className="hover:text-primary transition-colors">Eyelash Extensions</a></li>
              </ul>
            </div>
            <div>
